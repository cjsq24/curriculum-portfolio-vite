    ...
    <div className="l-about-me-content">
      ...
      <div className="l-about-me-information">
        ...
        <p className="l-about-me-paragraph">
          ¡Hola! Mi nombre es Carlos Sosa. Soy Desarrollador Web y Móvil. Cuento
          ...
          Bootstrap y ahora aprendiendo Laravel). Tengo un año aproximadamente
          trabajando en proyectos con React, React Native y Node JS. Quiero
          seguir especializándome en estas últimas tecnologías y así seguir
          adquiriendo más experiencia, siempre abierto a aprender. Me gusta
          trabajar en equipo, me gusta el análisis y la resolución de problemas
