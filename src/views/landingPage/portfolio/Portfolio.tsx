...
/* const images = [
  ...
  {
    title: '2',
    url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQf48SQxa5o0r1yASNX0sxIsNPkWUxUJdwE8XhZi_VZ66xuFrGWPuuO2ezfJr59OF3RYCE&usqp=CAU',
  },
  {
    title: '3',
    url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzkswKOsz0kT0e4vofsH2TUf0-3BhyqZ6NiWvHLyoFVi-lf-P51Xn7t6pcwrB2PClUV3g&usqp=CAU',
  },
] */
      ...
      <div className="l-card">
        {portfolioList.map((portfolio, i) => (
          <article key={i} className="l-portfolio-content-item">
            <header
              className="l-portfolio-item"
              onClick={() => showDescription(i)}
            >
              <span className="l-portfolio-item-title">{portfolio.title}</span>
            </header>
            <main
              className="l-portfolio-description"
              id={`l-portfolio-description-${i}`}
            >
              {portfolio.images && (
                <Carousel arrows>
              ...
              <p className="l-portfolio-description-text">
